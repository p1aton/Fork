...
cur.execute("""
    ...
    """, (idw, idc, idp, idbtfnx, idbinance, idbittrex))out_com = {'wex':{'btc':0.001, "ltc":0.001, 'nmc':0.1, 'ppc':0.1, 'dsh':0.001, 'eth':0.003, 'bch':0.001, 'zec':0.001},
...
conn = psycopg2.connect(conn_string)
cur = conn.cursor()
psycopg2.extras.execute_values(cur, "INSERT INTO pairs(fex, sex, br, fvalue, svalue, delta) values %s", itog)
conn.commit()
cur.close()
conn.close()
